...
// Serves staged images ("uploads/…") so the create form can show thumbnails
// of files imported by URL before the model exists. Images only — staged
// keys are unguessable UUIDs, but this must not become a general S3 proxy.
